...
const Checkout = () => {
    ...
    return (
        <div className='w-full mx-auto'>
            ...
            <div className='text-center font-raleway w-full mx-w-5xl mx-auto my-6'>
                <div className='font-extrabold text-transparent text-6xl my-10 bg-clip-text bg-gradient-to-r from-blue-400 to-red-800'>
                    Image Seller
                </div>
